...
public sealed class LlmRouteSelector
{
    ...
    public IReadOnlyList<LlmRouteConfig> MatchRoutes(LlmConfig config, LlmRequestRequirements requirements)
    {
    ...
    public LlmRouteConfig SelectRoute(LlmConfig config, LlmRequestRequirements requirements)
    {
        ...
        var selected = MatchRoutes(config, requirements).FirstOrDefault();
