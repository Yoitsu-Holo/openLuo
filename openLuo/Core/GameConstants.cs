...
public static class GameConstants
{
    ...
    /// <summary>Stable storage key for a relationship stage (persisted/API value).</summary>
    public static string ToStageStorageKey(RelationshipStage stage) => stage switch
    {
